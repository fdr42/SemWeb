        ...
        axios.get('http://localhost:8080/proximityRest?lon=' + this.longitude + '&lat=' + this.latitude)
            .then(function (response) {
                ...
                for (var item in results) {
                    ...
                    markProx.bindPopup(
                        "<img src=\"" + results[i].image + "\" alt=\"" + placeLabel + "\"style=\"width:100%;height:200px;\">" +
                        "<br /><b>" + placeLabel + "</b><br /> Se situe à " + results[i].dist * 1000 + "m de la station " + stationActuelle + "<br /><em>" + results[i].placeDescription + ".</em>"
                    ).openPopup();
